                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="book-section-info">
                                ...
                                <p>Travel Jaya Umroh hadir untuk memenuhi kebutuhan umat Islam dalam menjalankan ibadah umroh dan haji dengan amanah, profesional, dan terjangkau. Didukung oleh tim berpengalaman, layanan berkualitas, dan fasilitas terbaik, Travel Jaya Umroh berkomitmen memastikan kenyamanan dan kekhusyukan jamaah selama perjalanan ibadah.</p>

                                <p>Fokus utama perusahaan adalah memberikan pelayanan yang mengutamakan kepuasan jamaah, mulai dari proses pendaftaran hingga kepulangan ke tanah air. Dengan motto "Ibadah Nyaman, Hati Tenang", Travel Jaya Umroh berusaha menjadi mitra perjalanan terbaik dalam mewujudkan impian ibadah suci Anda.</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    ...
                    <div class="row m-5">
                        ...
                        <div class="col-lg-6 col-12 mt-5 mt-lg-0">
                            ...
                            <p>{{ $data->email }}</p>
                            <p>Kami membuat Travel Jaya Umroh untuk mempermudah masyarakat untuk pergi melaksanakan rukun islam ke-5</p>
                        </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="custom-block d-flex flex-wrap">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <p class="mb-0">Fasilitas: Hotel bintang 3, transportasi AC, makanan 3 kali sehari, pembimbing ibadah.</p>
                        ...
                        <div class="col-lg-4 col-12 my-5 my-lg-0">
                            <div class="custom-block d-flex flex-wrap">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <p class="mb-0">Fasilitas: Hotel bintang 4, transportasi AC eksklusif, makanan 3 kali sehari dengan menu Indonesia, pembimbing ibadah berpengalaman, perlengkapan umroh.</p>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="custom-block d-flex flex-wrap">
                                ...
                                <div class="custom-block-info">
                                    ...
                                    <p class="mb-0">Durasi: 12 hari</p>
                                    <p class="mb-0">Fasilitas: Hotel bintang 5 dekat Masjidil Haram & Masjid Nabawi, transportasi mewah, makanan premium, pembimbing ibadah senior, layanan fast track, dan asuransi perjalanan.</p>
